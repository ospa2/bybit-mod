...
const bankVariants: BankVariants = {
   ...
   Озон: ["озон", "озона", "озоне", "озоном", "озон банк", "ozon"],
};
...
function removeRecipientBanks(text: string): string {
   ...
   const recipientPatterns = [
      ...
      new RegExp(
         `\\s+(?:на|в)(?:\\s+(?:на|в))*\\s+(?:карту\\s+)?[а-яё0-9\\-\\s]+?(?=\\s*[+\\(]|${boundary})`,
         "gimu"
      ),
      // "перевод на/в"
      new RegExp(
